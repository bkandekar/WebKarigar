/**
 * WebKarigar - Main JavaScript Module
...
(function () {
  ...
  const CONFIG = {
    ...
    defaultEnquiryMessage: 'Hello WebKarigar, I am interested in getting a website for my business.',
    siteUrl: 'https://bkandekar.github.io/WebKarigar',
    brandName: 'WebKarigar',
...
// 6A. Single Post Page Renderer
  async function renderSinglePost() {
    ...
    if (schemaScript) {
      const schemaData = {
        ...
        "publisher": {
          "@type": "Organization",
          "name": "WebKarigar (ebookcharm Web Services)",
          "logo": { "@type": "ImageObject", "url": "https://bkandekar.github.io/WebKarigar/images/logo.png" }
        },
  ...
  function initDemoModalPreview() {
    ...
    function openModal(btn) {
      ...
      if (browserUrl) browserUrl.textContent = `https://bkandekar.github.io/WebKarigar/preview/${demoId}`;

      if (orderBtn) {
        const orderMsg = `Hi WebKarigar, I saw the *${title}* demo website and want to build a similar website for my business!`;
